...
// Importamos el nuevo módulo de las arañas
import 'package:supabase_notes/app/modules/add_spider/bindings/add_spider_binding.dart';
import 'package:supabase_notes/app/modules/add_spider/views/add_spider_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    // NUESTRA NUEVA RUTA
    GetPage(
      name: _Paths.ADD_SPIDER,
      page: () => const AddSpiderView(),
      binding: AddSpiderBinding(),
    ),
  ];
}